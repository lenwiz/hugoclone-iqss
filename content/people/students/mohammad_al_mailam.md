---
date: '2026-05-26 14:00:46'
draft: false
section: people
source_url: https://iq.harvard.edu/people/mohammad-al-mailam
title: Mohammad Al
---

<main aria-label="Mohammad Al-Mailam" aria-labelledby="page-title" id="main-content" lang="en" role="main" tabindex="-1">
...
<div>Graduate Student, Master of Arts Regional Studies--Middle East</div>
</div>
</div>
</div>
</div>
...
<a class="hwp-break-all" href="mailto:malmailam@fas.harvard.edu">malmailam@fas.harvard.edu</a>
</div>
</div>
</div>
</div>
...
<div class="hwp-text-block field field--name-field-hwp-body field--type-text-long field--label-hidden"><p>	Mohammad is a second-year graduate student interested in political economy, migration, and ethnic politics. His research draws on archival methods and survey experiments to study institutional change and identitarian political behavior in the Middle East. Before Harvard, Mohammad was a James C. Gaither Junior Fellow at the Carnegie Endowment for International Peace.</p></div>
</div>
</div>
</div>
</div>
...
*Original source: [https://iq.harvard.edu/people/mohammad-al-mailam](https://iq.harvard.edu/people/mohammad-al-mailam)*
