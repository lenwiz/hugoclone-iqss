---
date: '2026-05-26 14:41:16'
draft: false
section: people
source_url: https://iq.harvard.edu/people/ben-shair-0
title: Ben Shair
---

<main aria-label="Ben  Shair" aria-labelledby="page-title" id="main-content" lang="en" role="main" tabindex="-1">
...
<div>Undergraduate student, B.S. in Political Science at University of Rochester</div>
</div>
</div>
</div>
</div>
...
<a class="hwp-break-all" href="mailto:benshair1@gmail.com">benshair1@gmail.com</a>
</div>
</div>
</div>
</div>
...
<div class="hwp-text-block field field--name-field-hwp-body field--type-text-long field--label-hidden">Ben is currently assisting research on neighborhoods in American cities and their impact on the fields of preexisting neighborhood-based literature and redistricting with Professors Stephen Ansolabehere and Ryan Enos. His interests include American elections and public opinion, political geography, and demography.</div>
</div>
</div>
</div>
</div>
...
*Original source: [https://iq.harvard.edu/people/ben-shair-0](https://iq.harvard.edu/people/ben-shair-0)*
