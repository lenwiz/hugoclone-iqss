---
date: '2026-05-26 14:42:13'
draft: false
section: people
source_url: https://iq.harvard.edu/people/caterina-stamoulis
title: Caterina Stamoulis
---

<main aria-label="Caterina Stamoulis" aria-labelledby="page-title" id="main-content" lang="en" role="main" tabindex="-1">
...
<div>Associate Professor of Pediatrics, Harvard Medical School/Department of Pediatrics</div>
</div>
</div>
</div>
</div>
...
<source height="600" media="all and (min-width: 0)" srcset="/sites/g/files/omnuum8171/files/styles/hwp_4_5__480x600/public/harvard-iqss/files/stamoulis-caterina.jpg?itok=eNiccz8E 1x, /sites/g/files/omnuum8171/files/styles/hwp_4_5__960x1200/public/harvard-iqss/files/stamoulis-caterina.jpg?itok=iIt4ITnA 2x" type="image/jpeg" width="480"/>
<img alt="Caterina Stamoulis" height="600" loading="lazy" src="/sites/g/files/omnuum8171/files/styles/hwp_4_5__480x600/public/harvard-iqss/files/stamoulis-caterina.jpg?itok=eNiccz8E" width="480"/>
</picture>
</div>
</div>
</div>
...
<a class="hwp-break-all" href="mailto:caterina.stamoulis@childrens.harvard.edu">caterina.stamoulis@childrens.harvard.edu</a>
</div>
</div>
</div>
</div>
...
<div class="hwp-text-block field field--name-field-hwp-body field--type-text-long field--label-hidden">Dr. Stamoulis' research interests are at the intersection of Computational Cognitive Neuroscience and Data Science. She leads multiple projects that together aim to elucidate the evolving neural circuitry of the typically/atypically developing brain that supports cognitive function across domains, using large-scale brain datasets and novel computational tools. A recent research direction in her laboratory aims to bridge Neuroscience with the Socials Sciences through Data Science and elucidate the impact of the individual brain's topological organization (the connectome) on group/collective behaviors (e.g., cooperation).  </div>
</div>
</div>
</div>
</div>
...
*Original source: [https://iq.harvard.edu/people/caterina-stamoulis](https://iq.harvard.edu/people/caterina-stamoulis)*
