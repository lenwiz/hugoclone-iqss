---
date: '2026-05-26 14:40:12'
draft: false
section: people
source_url: https://iq.harvard.edu/people/ankana-saha
title: Ankana Saha
---

<main aria-label="Ankana Saha" aria-labelledby="page-title" id="main-content" lang="en" role="main" tabindex="-1">
...
<div>PhD Student in Linguistics, GSAS</div>
</div>
</div>
</div>
</div>
...
<source height="600" media="all and (min-width: 0)" srcset="/sites/g/files/omnuum8171/files/styles/hwp_4_5__480x600/public/harvard-iqss/files/ankana-saha_2023.jpg?itok=MHOYITFK 1x, /sites/g/files/omnuum8171/files/styles/hwp_4_5__960x1200/public/harvard-iqss/files/ankana-saha_2023.jpg?itok=5H-UpROZ 2x" type="image/jpeg" width="480"/>
<img alt="Ankana Saha" height="600" loading="lazy" src="/sites/g/files/omnuum8171/files/styles/hwp_4_5__480x600/public/harvard-iqss/files/ankana-saha_2023.jpg?itok=MHOYITFK" width="480"/>
</picture>
</div>
</div>
</div>
</div>
<div class="hwp-person-card__information hwp-bg-light-base hwp-flex-1"> <div class="hwp-mb-24 hwp-flex hwp-flex-col hwp-gap-20">
<div class="hwp-flex hwp-gap-8 hwp-items-center">
<span aria-hidden="true" class="material-icon">laptop_windows</span>
<a href="/sites.google.com/g.harvard.edu/ankanasaha">Website</a>
</div>
<div class="hwp-flex hwp-gap-8 hwp-items-center">
<span aria-hidden="true" class="material-icon">laptop_windows</span>
<a href="http://linkedin.com/in/ankana-saha">LinkedIn</a>
</div>
</div>
</div>
</div>
...
<div class="hwp-text-block field field--name-field-hwp-body field--type-text-long field--label-hidden"><p>	Ankana is a PhD student in the Department of Linguistics studying natural language semantics. She uses tools of formal mathematics and logic to study how utterances come to have the meanings they do, and how meaning interacts with linguistic structure and discourse contexts. She is particularly interested in investigating issues pertaining to the nominal domain like the semantics of bare nouns in languages with and without determiners, kind reference, number marking, definiteness, demonstratives, anaphora, and the cross-linguistic variability in the expression of epistemic indefinites. She explores these issues using a mix of formal theory, experimental methods, and fieldwork, with an empirical focus on South Asian languages. In her current collaborative project, she uses experimental and quantitative methodology to investigate the behavior of definite descriptions and demonstrative expressions in anaphoric contexts in order to understand the core building blocks of definiteness in Language.</p></div>
</div>
</div>
</div>
</div>
...
*Original source: [https://iq.harvard.edu/people/ankana-saha](https://iq.harvard.edu/people/ankana-saha)*
