---
date: '2026-05-26 13:39:34'
draft: false
layout: single-iqss
section: technology
source_url: https://www.iq.harvard.edu/client-support-services/rce-documentation
title: RCE Documentation
---

<main aria-label="RCE Documentation" aria-labelledby="page-title" id="main-content" lang="en" role="main" tabindex="-1">
...
<div class="hwp-text-block field field--name-field-hwp-body field--type-text-long field--label-hidden"><p>	Extensive documentation is available on the <a href="http://projects.iq.harvard.edu/rce">Research Computing Environment (RCE) site</a>.</p></div>
</div>
</div>
</div>
</article>
